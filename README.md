# 复杂理科图解助手 —— 万象 Wan 2.7 科学机制图解卡片 Skill 🧬⚡🧪
...
**核心应用场景：把复杂理科机制“图解化 + 卡片化”**

面向科研工作者、高校教师与各学段学生，本 Skill 用于将抽象、复杂的科学理论、实验机制、前沿猜想进行可视化表达，快速生成一套**「直观剖析机制图 + 骨干要素卡片」**的一体化输出物（可用于授课投屏、复习卡片、SCI 图文摘要、基金/组会汇报等）。

支持范围：覆盖 **化学/化工、物理/机电、生物/医学、材料/前沿交叉** 等理科方向；适用深度从 **基础科普/中小学 → 高考备战/大学本科 → 科研工作者（发论文/组会）**。
...
- 🖨️ **图文黄金排版**：预装指令控制出图呈现 16:9 或 A4 横版比例，强制左侧 55% 画面留给插图，右侧 45% 留白用于知识点叠写，随时可用作课堂投屏或学生速记复习卡。
